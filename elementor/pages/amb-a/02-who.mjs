...
const CELLS = [
  { modifier: 'aba-mosaic__cell--1', photo: 'mentor-with-student' },
  { modifier: 'aba-mosaic__cell--2', photo: 'speaker-at-microphone' },
  { modifier: 'aba-mosaic__cell--3', photo: 'panel-on-stage' },
